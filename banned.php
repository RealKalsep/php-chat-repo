...
<body>
<?php
$blocked = array("<style>", "<script>"); // obsolete, if I see this exact line one more time, I'm going to jump
...
<div class="chat">
<p>You're banned! If you want to appeal or think that this is a mistake, write us on: insert email</p>
</div>
</body>
</html>